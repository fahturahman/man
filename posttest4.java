...
class Barang {
    ...
    public void tambahBarang(String nama, int harga, int stok) {
        System.out.println("Method tambahBarang dari class Barang dipanggil");
    }
...
class Elektronik extends Barang {
    ...
    public void tambahBarang(String nama, int harga, int stok, String merek) {
        System.out.println("Method tambahBarang dari class Elektronik dipanggil");
    }
}

class BolaBilliard extends Barang {
    ...
    public void tambahBarang(String nama, int harga, int stok, String jenisBola) {
